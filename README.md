Secret-Message is a simple sharing message app (along with tutorial from The Modern JS Bootcamp by Stephen Grider). Is created with HTML, CSS library Materialize, and JavaScript;
